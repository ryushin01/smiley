...
import { Alert, Button, Header, Typography } from "@components";
...
import cntrDetailData from "@data/cntr-searchCntrDetail/03/cntr-searchCntrDetail.json";
  ...
  useEffect(() => {
    ...
    if (!!cntrDetailData.data) {
      ...
      if (isResExecAmtChngd && isPayAmtRegd) {
        /* TODO : sr건일때, 지급정보 다녀오면 팝업안뜨게 변경 */
        // if (prevPath === "/my-case/sr-pay-info" && isSr) {
        //   return;
        // } else {
        // }
        return openResExecAmtChngd();
      ...
      // SR 건
      if (isSr && cntrDetailData?.data.statCd < "10") {
        return openSrCase();
      }
    }
  }, [cntrDetailData.data]);
