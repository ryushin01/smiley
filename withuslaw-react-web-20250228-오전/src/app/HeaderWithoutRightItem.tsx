    ...
    switch (true) {
        ...
        return {
          ...
          backCallBack: () => {
            if (prevPath === `/acceptance/match/${loanNo}`) {
              ...
              console.log("prevPath 222", prevPath);
              console.log("loanNo??", getLoanNo);
              router.push(`/acceptance/match/accept-get?loanNo=${getLoanNo}`);
              // router.push(`/acceptance/match/accept-get?loanNo=${loanNo}`);
            }
          },
        };
      ...
      case pathname === "/my-case/estm/info/list" &&
        ...
        return {
          isBackButton: true,
          title: "견적서",
          backPath: `/my-case/estm/info/schdl?loanNo=${getLoanNo}&isDDay=true`,
        };
      ...
      case pathname === "/my-case/estm/info/list" &&
        ...
        return {
          ...
          backCallBack: () => {
            console.log("prevPath 444", prevPath);
            console.log("loanNo22", getLoanNo);
            if (prevPath === `/acceptance/match/accept-get`) {
              router.back();
            } else {
              router.push(
                `/my-case/estm/info?loanNo=${getLoanNo}&isDDay=false`
              );
            }
          },
        };
