...
export default function MY_TR_001_M() {
  ...
  const handleSearchResultClick = (regoNm: string, regoCd: string) => {
    ...
    setValue("regoCd", regoCd); // React Hook Form에 반영
    close(); // 검색창 닫기
  };
  ...
  const onSubmit = (data: TForm) => {
    ...
    console.log("data", data.regoNm);
    console.log("data", regType);
    console.log("data", ...data.esNums);
    console.log("data", ...data.bfNums);
    console.log("data", ...data.erNums);
