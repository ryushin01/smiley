...
- 프론트엔드 기술 스택
	...
	- 코드 포맷터: Prettier
	- 기타 패키지
		- 숫자 천단위 콤마 처리: react-currency-format > ==다른 패키지 검색 필요==
			- [x] better-thousand-separator
			- [ ] [react-number-format(v4.5.0)](https://www.npmjs.com/package/react-number-format/v/4.5.0)
